...
function Cog8ToothIcon({ className = "" }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
function Cube16SolidIcon({ className = "" }: { className?: string }) {
  return (
...
function LinkSolidIcon({ className = "" }: { className?: string }) {
  return (
